 ...
 * @param { string } loadingConfigurationOptions.ruleLocation - the location of the file relative to the project root
 * @param { Map<string, object> } loadingConfigurationOptions.configuration - a map of vars to provide as the Auth0 configuration global
 * @param { Map<string, object> } loadingConfigurationOptions.mapOfRequiredModulesToReplaceWithMocks - a map of mocks to be used as substitutes for required modules.
 * The key of each item should correspond with the string supplied to `require` to import the module.
 * @returns {Function}
 */
